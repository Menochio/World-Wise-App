...
function Button({ children, disabled, to, type, onClick }) {
  const base = `inline-block text-sm rounded-full bg-yellow-400 font-semibold uppercase tracking-wide text-stone-800 transition-colors
  ...
  const styles = {
    ...
    secondary: `text-sm inline-block rounded-full border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-800 transition-colors
    ...
    disabled:cursor-not-allowed px-4 py-2.5 sm:px-6 sm:py-4`,
  };
  if (to)
    return (
